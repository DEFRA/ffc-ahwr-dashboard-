...
const SURVEY_LINK =
  "https://defragroup.eu.qualtrics.com/jfe/form/SV_0lxBrd2XeDnn2hU";
...
class SelectBusinessPage extends CommonActions {
  ...
  async chooseBusinessPageIsDisplayed() {
    const elm = "#attributeVerificationReplacement #resultsContainer";
    await this.isElementExist(elm);
  }
